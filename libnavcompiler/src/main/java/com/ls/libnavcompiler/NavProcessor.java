 ...
 * 3. AutoService：用这个版本的依赖：annotationProcessor 'com.google.auto.service:auto-service:1.0-rc7'
 *    不然1.0-rc4会报错
 * 4. 注释报错问题：添加
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        if (!fragmentElements.isEmpty()||!activityElements.isEmpty()){
            ...
            try {
                ...
                String appPath = resourcePath.substring(0, resourcePath.indexOf("app"));
